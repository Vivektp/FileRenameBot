...
"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me JOin > @VKPROJECTS  ❤️**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @VKSupportHelp "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @VKSupportHelp "
